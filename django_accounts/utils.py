'''
    ...
    toTimeAgo()    - Pretty time ago text from date
    beautifyNumber - Converts numbers to beautiful short string (e.g. 1,000,000 -> 1M)
    markup()       - Converts markdown to HTML markup (including code highlighting)
