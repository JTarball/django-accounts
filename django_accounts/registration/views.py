#!/usr/bin/env python
"""
    django_accounts.registration.views
    ==================================
...
from django_accounts.serializers import TokenSerializer
from django_accounts.views import LoginView
...
class RegisterView(APIView, SignupView):
    ...
    # HACK: PUT & GET METHOD (PATCH, DELETE WORK OK)
    # because of the complex class hierachy of SignupView
    # and its call of dispatch we dont get the APIView
    # default get / put response from allowed methods
    # we have to instead explicitly state it here
